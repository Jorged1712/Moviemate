...
export const Footer = () => {
  const Logo = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI4iLANk3LTCv7Y5FnoX2i3ThPAe3CTJgP6A&s'
        ...
        <div className ="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className ="sm:flex sm:items-center sm:justify-between">
            <Link to="/" className ="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
              ...
              <span className ="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">@IMJM</span>
            </Link>
